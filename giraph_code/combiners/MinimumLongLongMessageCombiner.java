...
/**
 * MessageCombiner which finds the minimum of {@link LongWritable}.
 */
public class MinimumLongLongMessageCombiner
    implements MessageCombiner<LongWritable, LongWritable> {
  @Override
  public void combine(LongWritable vertexIndex,
      LongWritable originalMessage, LongWritable messageToCombine) {
