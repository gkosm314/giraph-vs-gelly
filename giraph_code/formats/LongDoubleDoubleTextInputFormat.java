...
public class LongDoubleDoubleTextInputFormat extends TextVertexInputFormat<
    LongWritable, DoubleWritable, DoubleWritable> {
  @Override
  public TextVertexReader createVertexReader(
      InputSplit split, TaskAttemptContext context) throws IOException {
    return new LongDoubleDoubleNullVertexReader();
  }

  /**
   * Reader for this InputFormat.
   */
  public class LongDoubleDoubleNullVertexReader extends
