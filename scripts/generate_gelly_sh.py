...
#command fstring
gelly_str = "./flink-1.14.4/bin/flink run -p {} gelly-algorithms/target/gelly-algorithms-1.0-SNAPSHOT.jar hdfs://master:9100/user/datasets/{} {} {}"
    ...
    for i in range(1,number_of_workers+1):
        for dataset in datasets:
            ...
            for algo in algorithms:
                ...
                command_str = "(time " + gelly_str.format(i, dataset, output_param, algo) + ") 2> " + time_file
